...
Note: this project is based on https://github.com/RicardoNiepel/C4-PlantUML and includes modifications for adding message bus, person icon to the Person macro, and other additions I personally found useful. Many thanks to the original project created that this fork is based on.
...
```c#
!includeurl https://raw.githubusercontent.com/jozbone/C4-PlantUML/release/1-0/C4_Container.puml
```
